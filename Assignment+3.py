...
def answer_one():
    ...
    energy['Country'].replace("Iran, Islamic Rep.", "Iran",inplace=True)
    ...
    New = pd.merge(ScimEn.ix[:14],energy,how = 'left',left_on = 'Country',right_on='Country')
    c_to_keep = ['Country Name','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015']
    New = pd.merge(New,GDP[c_to_keep],how = 'left',left_on='Country', right_on = 'Country Name')
    New.set_index('Country',inplace = True)
    col_return = ['Rank', 'Documents', 'Citable documents', 'Citations', 'Self-citations', 'Citations per document', 'H index', 'Energy Supply', 'Energy Supply per Capita', '% Renewable', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015']
    return New[col_return]
...
def answer_three():
    ...
    import numpy as np
    Top15 = answer_one()
    temp3 = Top15[['2006','2007','2008','2009','2010','2011','2012','2013','2014','2015']]
    avgGDP = temp3.dropna().mean(axis = 1)
    avgGDP.sort(ascending = 0, inplace = True)
...
def answer_six():
    ...
    return tuple(Top15[['% Renewable']].sort('% Renewable',ascending = 0).head(1))
...
def answer_seven():
    ...
    import numpy as np
    Top15 = answer_one()
    Top15['sc/tc'] = Top15['Self-citations']/Top15['Citations']

    return tuple(Top15[['sc/tc']].sort('sc/tc',ascending = 0).head(1))
...
def answer_eight():
    ...
    return Top15.sort('pop',ascending = 0).index[2]
...
def answer_nine():
    ...
    Top15['cd/p'] = Top15['Citable documents']/Top15['pop']

    return Top15['cd/p'].corr(Top15['Energy Supply per Capita'],method='pearson')
...
def answer_ten():
    ...
    mid = Top15['% Renewable'][int((15+1)/2)]
...
def answer_twelve():
    ...
    import numpy as np
    Top15 = answer_one()
    return Top15.groupby([ContinentDict,pd.cut(Top15['% Renewable'],5)])['Rank'].agg({'Number of Countries': np.size})
